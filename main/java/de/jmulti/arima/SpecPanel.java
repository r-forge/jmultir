...
public final class SpecPanel extends ModelPanel {
    ...
    TSSel getTSSel() {
        if (tSSel == null) {
            ...
            tSSel
                    .setDeterministicStringsName(ARIMAConstants.DET_NAMES_SEL.name);
        }
    ...
    private JPanel getJPanel() {
        if (jPanel == null) {
            ...
            jLabel5 = new JLabel();
            jLabel5
                    .setText("Fixed regressors, others may be selected as \"deterministic\" with the selector");
    ...
    private void assembleDeterministics() {
        global().get(ARIMAConstants.D).setJSCData(
                new JSCInt("D", dComboBox.getSelectedIndex()));

        JSCNArray selection = new JSCNArray("DET_SEL", new int[] {
                getConstCheckBox().isSelected() ? 1 : 0,
                getSeasCheckBox().isSelected() ? 1 : 0,
                getTrendCheckBox().isSelected() ? 1 : 0 });
        ...
        JSCNArray det_data_all = global().get(ARIMAConstants.DET_DATA_ALL)
                .getJSCNArray();
        JSCSArray det_names_all = global().get(ARIMAConstants.DET_NAMES_ALL)
                .getJSCSArray();
        det_data_all.clear();
        det_names_all.clear();
        ...
        // also append selected variables and names last
        JSCNArray det_data_sel = global().get(ARIMAConstants.DET_DATA_SEL)
                .getJSCNArray();
        JSCSArray detNames_sel = global().get(ARIMAConstants.DET_NAMES_SEL)
                .getJSCSArray();
            ...
            jPanel2
                    .setBorder(javax.swing.BorderFactory
                            .createTitledBorder(
                                    javax.swing.BorderFactory
                                            .createBevelBorder(javax.swing.border.BevelBorder.LOWERED),
                                    "Hannan-Rissanen Model Selection",
                                    javax.swing.border.TitledBorder.RIGHT,
                                    javax.swing.border.TitledBorder.DEFAULT_POSITION,
                                    new java.awt.Font("Dialog",
                                            java.awt.Font.PLAIN, 10),
    ...
    private JPanel getJPanel3() {
        if (jPanel3 == null) {
            ...
            jLabel6 = new JLabel();
            jLabel6
                    .setText("Searches optimal AR and MA lags, uses settings for d and fixed regressors");
        ...
        if (okButton == null) {
            ...
            okButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    if (y.isEmpty()) {
                        StdMessages
                                .infoNothingSelected("Please select a series first.");
                        return;
                    }
                    ...
                    if (pqmax >= h) {
                        StdMessages
                                .errorInput("Maximum lag number must be smaller than h.");
                        return;
                    }
                    int rows = y.rows();
                    ...
                    if (rows - d - 2 * h < 1) {
                        StdMessages
                                .errorInput("Not enough observations. Please choose a smaller h.");
                        return;
                    }
                    if (pqmax >= (rows - d - h) / 4) {
                        StdMessages
                                .errorInput("Not enough observations. Please reduce the maximum number of lags.");
                        return;
                    }
                    ...
                    PCall job = new ARIMAHanRissPCall(h, pqmax, d, y, global()
                            .get(ARIMAConstants.DET_DATA_ALL).getJSCNArray(),
                            global().get(ARIMAConstants.END_NAME)
                                    .getJSCSArray().stringAt(0, 0), global()
                                    .get(ARIMAConstants.DRANGE).getJSCDRange()
                                    .getTSDateRange());
        ...
        if (seasCheckBox == null) {
            ...
            seasCheckBox.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    } else if (!getTrendCheckBox().isSelected())
                        getConstCheckBox().setEnabled(true);
                    ...
                    .addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent e) {
                            if (trendCheckBox.isSelected()) {
                                getConstCheckBox().setSelected(true);
                                getConstCheckBox().setEnabled(false);
                            } else if (!getSeasCheckBox().isSelected())
                                getConstCheckBox().setEnabled(true);
                        }
                    });
        }
