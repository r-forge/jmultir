 ...
 */
public class UnivarAutocorrPanel extends ModelPanel {
    private static final Logger log = Logger
            .getLogger(UnivarAutocorrPanel.class);
    ...
    class IvjEventHandler implements java.awt.event.ActionListener {
        public void actionPerformed(java.awt.event.ActionEvent e) {
            if (e.getSource() == UnivarAutocorrPanel.this.getAutocorrelation())
                connEtoC1();
        };
    };
    ...
    private void autocorrelation_ActionEvents() {
        ...
        PCall jobAuto = new AutocorrCall(global().get(resids).getJSCNArray(),
                new JSCSArray("nam", new String[] { "resids" }), maxLags,
                getSquaredCheck().isSelected(), getAutocorrText().isSelected(),
                false);
    ...
    private javax.swing.JButton getAutocorrelation() {
        if (ivjAutocorrelation == null) {
            try {
                ...
                ivjAutocorrelation.setPreferredSize(new java.awt.Dimension(120,
                        27));
                // user code begin {1}
                // user code end
            } catch (Throwable ivjExc) {
    ...
    private javax.swing.JCheckBox getAutocorrText() {
        if (ivjAutocorrText == null) {
            try {
                ...
                ivjAutocorrText.setText("Output as text");
                // user code begin {1}
                // user code end
            } catch (Throwable ivjExc) {
                // user code begin {2}
    ...
    private javax.swing.JPanel getCorrTab() {
        if (ivjCorrTab == null) {
            try {
                ...
                ivjCorrTab.setPreferredSize(new java.awt.Dimension(200,100));
                ...
                constraintsAutocorrelation.anchor = java.awt.GridBagConstraints.SOUTHWEST;
                constraintsAutocorrelation.weightx = 1.0D;
                constraintsAutocorrelation.weighty = 1.0D;
                constraintsAutocorrelation.insets = new java.awt.Insets(5,5,5,5);
                ...
                constraintsAutocorrText.anchor = java.awt.GridBagConstraints.NORTH;
                constraintsAutocorrText.weighty = 0.0D;
                constraintsAutocorrText.insets = new java.awt.Insets(10,15,5,0);
                ...
                constraintsSquaredCheck.anchor = java.awt.GridBagConstraints.NORTH;
                constraintsSquaredCheck.insets = new java.awt.Insets(10,5,0,0);
                ivjCorrTab.add(getMaxLags(), constraintsMaxLags);
                ivjCorrTab.add(getJLabel1(), constraintsJLabel1);
                ivjCorrTab.add(getAutocorrelation(), constraintsAutocorrelation);
                ivjCorrTab.add(getAutocorrText(), constraintsAutocorrText);
                ivjCorrTab.add(getSquaredCheck(), constraintsSquaredCheck);
                // user code end
            } catch (Throwable ivjExc) {
                // user code begin {2}
                // user code end
    ...
    private javax.swing.JLabel getJLabel1() {
        if (ivjJLabel1 == null) {
            try {
                ...
                ivjJLabel1.setPreferredSize(new java.awt.Dimension(200,20));
    ...
    public void setResids(String resids) {
        this.resids = new JSCTypeDef(resids, JSCTypes.NARRAY);
    }
}