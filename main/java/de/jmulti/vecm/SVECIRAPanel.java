...
/**
 * This panel binds the components of the SVEC impulse response analysis
 ...
 */
public final class SVECIRAPanel extends ModelPanel {
    private static final Logger log = Logger.getLogger(SVECIRAPanel.class);
    ...
    private IRAComputePanel getIRAComputePanel() {
        if (ivjIRAComputePanel == null) {
            try {
                ...
                ivjIRAComputePanel.setModelType(ModelTypes.SVEC);
                // user code begin {1}
                // user code end
    ...
    private IRADisplayPanel getIRADisplayPanel() {
        if (ivjIRADisplayPanel == null) {
            try {
                ...
                ivjIRADisplayPanel.setModelType(ModelTypes.SVEC);
                // user code begin {1}
                // user code end
            } catch (Throwable ivjExc) {
                // user code begin {2}
    ...
    private void initialize() {
        ...
        global().get(SVECConstants.matB_Def).addSymbolListener(
                new SymbolListener() {
