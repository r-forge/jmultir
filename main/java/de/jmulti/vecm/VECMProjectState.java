...
public final class VECMProjectState implements ProjectState {
     ...
     */
    public static final XmlFormat<VECMProjectState> VECMProjectState_XML = new XmlFormat<VECMProjectState>(
            VECMProjectState.class) {
        ...
        public VECMProjectState parse(XmlElement xml) {
            ...
            if (xml.hasNext()) {
                ...
                if (SVECTable != null)
                    state.setSymbolTableSVEC(SVECTable);
            }
            if (xml.hasNext()) {
                JSCNArray ecSel = (JSCNArray) xml.getNext();
                if (ecSel != null)
                    state.setEcSelection(ecSel);
            }
            if (xml.hasNext()) {
                JSCNArray procSel = (JSCNArray) xml.getNext();
                if (procSel != null)
                    state.setStratSelection(procSel);
            }
            return state;
        }
    };
