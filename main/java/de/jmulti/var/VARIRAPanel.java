...
/**
 * This panel binds the components of the VAR impulse response analysis
 ...
 */
public final class VARIRAPanel extends ModelPanel {
    private static final Logger log = Logger.getLogger(VARIRAPanel.class);
    ...
    /**
     * VARIRAPanel constructor comment.
     */
    public VARIRAPanel() {
        super();
        initialize();
    ...
    /**
     * Return the IRADisplayPanelOrth property value.
     * 
